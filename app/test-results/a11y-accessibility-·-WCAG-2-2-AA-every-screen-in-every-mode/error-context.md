...
- Name: a11y.spec.ts >> accessibility · WCAG 2.2 AA >> every screen, in every mode
- Location: e2e/a11y.spec.ts:153:7

# Error details

```
Error: axe violations on Adaptar una ficha · oscuro · normal:
